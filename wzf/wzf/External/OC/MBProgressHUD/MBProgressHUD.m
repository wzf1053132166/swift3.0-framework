...
- (void)layoutSubviews {
    ...
    CGSize labelSize;
    {
        CGSize size_info = CGSizeMake(label.frame.size.width, MAXFLOAT);
        UIFont *font_info = label.font;
        
        NSMutableParagraphStyle *paragraphStyle = [[NSMutableParagraphStyle  alloc] init];
        paragraphStyle.alignment = label.textAlignment;
        paragraphStyle.lineBreakMode = label.lineBreakMode;
        
        labelSize = [label.text boundingRectWithSize:size_info options:NSStringDrawingUsesLineFragmentOrigin attributes:[NSDictionary dictionaryWithObjectsAndKeys: font_info, NSFontAttributeName, paragraphStyle, NSParagraphStyleAttributeName, nil] context:nil].size;
    }
    ...
    {
        CGSize size_info = maxSize;
        UIFont *font_info = detailsLabel.font;
        
        NSMutableParagraphStyle *paragraphStyle = [[NSMutableParagraphStyle  alloc] init];
        paragraphStyle.alignment = detailsLabel.textAlignment;
        paragraphStyle.lineBreakMode = detailsLabel.lineBreakMode;
        
        detailsLabelSize = [detailsLabel.text boundingRectWithSize:size_info options:NSStringDrawingUsesLineFragmentOrigin attributes:[NSDictionary dictionaryWithObjectsAndKeys:font_info, NSFontAttributeName, paragraphStyle, NSParagraphStyleAttributeName, nil] context:nil].size;
